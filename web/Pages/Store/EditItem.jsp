       ...
       <table style="border: 4px blue ridge">
            <%  
               ...
               int i = Integer.parseInt((String)request.getSession().getAttribute("itemlistiteration"));
                        ...
                        out.print("<form action=\"UpdateItem\" method=\"post\">");
                        out.print("<tr style=\"border: 4px blue ridge\">");
                         ...
                         out.print("<input type=\"hidden\" value="+si.get(i).getId()+" name=\"upitemid\" />"); 
                         
                         out.print("<td style=\"border: 4px blue ridge\">Description : </td>");
                         out.print("<td style=\"border: 4px green inset\"><input type=\"text\" name=\"newDesc\" value="+si.get(i).getDescription()+ "></td>");

                         out.print("<td style=\"border: 4px blue ridge\">Price : </td>");
                         out.print("<td style=\"border: 4px green inset\"><input type=\"text\" name=\"newPrice\" value="+si.get(i).getPrice()+ "></td>");

                         out.print("<td style=\"border: 4px blue ridge\">Quantity : </td>");
                         out.print("<td style=\"border: 4px green inset\"><input type=\"text\" name=\"newQuan\" value="+si.get(i).getQuantity()+ "></td>");
