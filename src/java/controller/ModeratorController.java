...
@WebServlet(name = "ModeratorController", urlPatterns = {"/ListUsers","/CreateUser","/CreateCategory","/SaveCategory","/DeleteCategory","/ViewCategory" , "/DeleteUser","/userInfo", "/Save","/Update"})
     ...
     switch (URL) {
       ...
       case "/SaveCategory":
         ...
         case "/ListUsers":
              ...
              List<User> adminUserList = (List<User>)MD.getAllUsers();
